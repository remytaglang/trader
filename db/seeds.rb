...
order6 = Order.create(name: "Power", currency: "power-ledger", abreviation: "POWR", prixentree: 0.62778900, totalentree: 59.64, number_achat: 95.00, owner: "Remy")
order7 = Order.create(name: "Factom", currency: "factom", abreviation: "FCT", prixentree: 23.77, totalentree: 59.72 , number_achat: 2.51234017, owner: "Remy")
